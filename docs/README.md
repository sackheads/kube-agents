...
| `agents/chat/AGENTS.md` | Runtime workspace | Operating doc for the Chat Agent: asynchronous delegation via the kanban board, roster discovery, red lines (route-don't-do, no infrastructure tools), stateless across sessions. | Kanban delegation, injected roster, red lines | Runtime doc; baked into the image |
